...
export class EpubBuilder {
    ...
    async loadMetadata() {
        ...
        try {
            this.metadata = await readJson(metaPath);
            return this.metadata;
        }
        catch {
     ...
     */
    getOutputPath(filename, isMerged) {
     ...
     */
    async processChapterContent(content) {
...
//# sourceMappingURL=epub-builder.js.map