 ...
 */
export async function readBooksList(): Promise<string[]> {
    try {
 ...
 */
export async function writeBooksList(books: string[]): Promise<void> {
 ...
 */
export async function addBookToList(folderName: string): Promise<boolean> {
 ...
 */
export async function removeBookFromList(folderName: string): Promise<boolean> {
    const booksList = await readBooksList();
 ...
 */
export async function isBookInList(folderName: string): Promise<boolean> {
    const booksList = await readBooksList();
